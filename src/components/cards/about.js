    ...
    return (
      <Div>
        ...
        <div>
          ...
          <div>
            <p>
              <span>Front-end</span> : [ "React" , "Redux" , "LESS",
            ...
            <p>
              <span>Database</span> : [ "Postgres" , "SQLite" , "Sequelize" ,
              "Knex" ,"MongoDB" ],{' '}
            </p>
            <p>
              <span>Deployment</span> : [ "Travis" , "Heroku" ,"Netlify" ],
            </p>
            <p>
              <span>Animations</span> : ["Gsap" ,"Figma" , "Photoshop" ] ,{' '}
            </p>
            <p>
              <span>Project Management</span>: ["Github", "Pivotal Tracker" ,
              "Trello"]
            </p>
          </div>
          <p>} </p>
          ...
          <p>
            "Not Developing Software" ? "Data Science" : "Volunteer Service"
          </p>
        </div>
        <p>{'}'} ;</p>
      </Div>
