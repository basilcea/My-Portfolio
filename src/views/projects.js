...
const data = [
  ...
  },
  {
    ...
    responsibilities: [
      "Build out backend for the app using node, postgres and raw sql",
  ...
  },
  {
    ...
    name: "Kids Fly API",
    description:
      "An app that enables parents flying with kids, a hassle free flight.",
...

  {
    ...
    description:
      "A multi-user real-time virtual world game where players can transverse rooms in four directions",
